...
- 🎯 Entry points to execute your program using `python -m <bumpkin>` or `$ bumpkin` with basic CLI argument parsing.
...
Awesome bumpkin created by lucasew
...
```py
from bumpkin import BaseClass
from bumpkin import base_function
